  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      <header className="flex items-end justify-between gap-3">
        <div><p className="ascii-kicker">~/localy/site_builder</p><h1 className="mt-1 text-2xl font-bold uppercase text-ink">+-- Сайт бизнеса --+</h1><p className="mt-1 text-sm text-ink-soft">Сначала настройте основу. Каталог и контакты можно раскрыть ниже.</p></div>
