...
export default async function SubscriptionPage() {
  ...
  return <div className="mx-auto max-w-6xl space-y-6"><header><p className="ascii-kicker">~/localy/subscription</p><h1 className="mt-1 text-2xl font-bold uppercase">+-- Тариф и подписка --+</h1><p className="mt-1 text-sm text-ink-soft">Текущий тариф «{plan.title}»{subscription.nextBillingAt ? ` · следующее списание ${dateShort(subscription.nextBillingAt)}` : ' · без списаний'}</p></header>
